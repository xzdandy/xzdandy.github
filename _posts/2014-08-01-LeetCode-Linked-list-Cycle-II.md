...
<div class="math">x + tl + m = 2(x + kl + m) \Rightarrow tl - 2kl = x + m \Rightarrow (tl - 2kl) mod l \equiv (x+m) mod l \equiv 0</div>
We all need is <span class="math">(x+m) mod l \equiv 0</span>
